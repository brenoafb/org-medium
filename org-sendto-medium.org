...
#+AUTHOR: Haoyang Xu
#+PROPERTY: header-args  :tangle "~/.emacs.d/lisp/org-sendto-medium.el"
...
*** Generate data from Org-Mode file
    ...
    #+BEGIN_SRC elisp
      (defun org-medium-get-content (title)
        ...
        (save-excursion
          (let ((buffer (org-md-export-as-markdown)))
            (org-medium-process-markdown buffer title))))

      (defun org-medium-process-markdown (buffer title)
